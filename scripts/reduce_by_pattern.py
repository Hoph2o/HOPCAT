...
def launch():
    ...
    INST_OPTIONS = ["Guitar", "Rhythm", "Bass", "Drums", "Keys"]
    ...
    instOpt = tkinter.OptionMenu(instSelect, instrument_var, *INST_OPTIONS)
    ...
    diffOpt = tkinter.OptionMenu(diffSel, diff_var, *DIFF_OPTIONS)
