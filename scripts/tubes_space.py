...
CAT_LABEL = "Add space between tubes"
CAT_CATEGORY = "Vocals"
CAT_ORDER = 1
...
def execute(sel):
    ...
    C3toolbox.startup()
    C3toolbox.tubes_space(instrument, sel) #instrument, level, option, selected
    form.destroy()
...
def launch():
    ...
    form.wm_title('Fix long phrase tubes')
    C3toolbox.startup()
...
if __name__ == '__main__':
    launch()
    #C3toolbox.startup()
    #C3toolbox.tubes_space('PART VOCALS', 1)
