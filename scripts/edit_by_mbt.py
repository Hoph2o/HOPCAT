...
def launch():
    ...
    measureOpt = tkinter.OptionMenu(helpLf, measure_var, *OPTIONS)
    ...
    beatOpt = tkinter.OptionMenu(helpLf, beat_var, *OPTIONS)
    ...
    ticksOpt = tkinter.OptionMenu(helpLf, ticks_var, *OPTIONS)
