...
CAT_LABEL = "Automatic reductions (5-lane)"
...
def launch(instrument):
    ...
    gridOpt = tkinter.OptionMenu(lvlHard, grid_var_h, *OPTIONS)
    ...
    if instrument_id == 0 or instrument_id == 5:
        snarehOpt = tkinter.OptionMenu(lvlHard, snareh_var, *OPTIONS)
    ...
    gridOpt = tkinter.OptionMenu(lvlMedium, grid_var_m, *OPTIONS)
    ...
    if instrument_id == 0 or instrument_id == 5:
        snaremOpt = tkinter.OptionMenu(lvlMedium, snarem_var, *OPTIONS)
    ...
    gridOpt = tkinter.OptionMenu(lvlEasy, grid_var_e, *OPTIONS)
    ...
    if instrument_id == 0 or instrument_id == 5:
        snareeOpt = tkinter.OptionMenu(lvlEasy, snaree_var, *OPTIONS)
    ...
    instrumentOpt = tkinter.OptionMenu(Options_grid, instrument_var, *OPTIONS)
    ...
    if instrument_id == 0 or instrument_id == 5:
        levelOpt = tkinter.OptionMenu(Options_grid, level_var, *OPTIONS)
