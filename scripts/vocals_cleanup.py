...
def launch():
    ...
    gridOpt = tkinter.OptionMenu(general, grid_var, *OPTIONS)
    ...
    precOpt = tkinter.OptionMenu(general, prec_var, *OPTIONS)
    ...
    precgrid_varOpt = tkinter.OptionMenu(general, precgrid_var, *OPTIONS)
    ...
    textOpt = tkinter.OptionMenu(lyrics, text_var, *OPTIONS)
